...
$fonte = @"
FFmpeg — binário de terceiro redistribuído com o LocalConverter
============================================================
...
LocalConverter não faz linkagem com as bibliotecas do FFmpeg: as duas obras são
apenas agregadas no mesmo instalador e cada uma mantém a sua licença — o
LocalConverter é MIT, o FFmpeg é GPL-3.0-or-later.
...
https://github.com/Anon5T4R/LocalConverter e ele será fornecido.
"@
